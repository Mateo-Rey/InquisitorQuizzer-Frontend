      ...
      <aside className="sidemenu">
        ...
        <div className="models">
          ...
          <div className="sidemenubutton intro-frame">
              <p> Welcome to a short project I made which allows for you to prompt my AI for questions, images, and even editing your own work!</p> <p>To get started type in the box at the bottom your question or prompt.</p>
          </div>
      </aside>
